      ...
      <div class="card mb-4">
        <form @submit.prevent="wellEditSubmit">
          <div class="card-header">
            <h3 class="card-title">Ekspeditsiya ma'lumotlari</h3>
...
import { getWell, getParameterNames, getParameter, getPredictions, 
  getNewWellForm, editWell, calculateParameters, uploadFile, sendExcelData, sendConfirmedExcelData, getHeatmap } from '@/api/melio';
