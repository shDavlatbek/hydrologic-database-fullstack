<template>
    ...
    <div class="page-body">
      <div class="container-xl">
          ...
          <DataTable :columns="[
            ...
            { key: 'station', label: 'Ekspeditsiya' },
        ...
        <template #modal-body>
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12">
                <InputField label="Ob'ekt raqami" :required="true" v-model.number="addWellForm.number"
                  type="number" />
              </div>
              <div class="col-lg-6 col-md-12">
                <SelectField label="Ob'ekt turi" v-model="addWellForm.well_type">
                  <option v-for="one in wellTypes" :key="one.id" :value="one.id">{{ one.name }}</option>
                </SelectField>
              </div>
              <div class="col-lg-6 col-md-12">
                <SelectField label="Ekspeditsiya nomi" v-model="addWellForm.station">
  ...
  import { addNewWell, getNewWellForm, getWells } from '@/api/melio';
  import { ref } from 'vue';
  ...
  export default {
    ...
    data() {
      return {
        title: "Gidromeliorativ ma'lumotlar",
    ...
    methods: {
      ...
      navigateToGeoSingle(item) {
        this.$router.push({ name: "MelioSingle", params: { number: item.number } });
      },
    },
