...
from services.melio import MelioService, ParameterService, ParameterNameService
...
async def add_well_form(
    ...
    return await MelioService().add_well_form(uow)
...
async def add_well(
    ...
    return await MelioService().add_well(uow, well)
...
async def get_wells(
    ...
    res = []
    wells = await MelioService().get_wells(uow)
    for well in wells:
        res.append(await MelioService().get_well(uow, well.number))
    return res
...
async def get_wells_with_parameters(
    ...
    return await MelioService().get_wells_with_parameters(uow, date)
...
async def get_well(
    ...
    return await MelioService().get_well(uow, number)
...
async def edit_well(
    ...
    return await MelioService().edit_well(uow, number, geo_well)